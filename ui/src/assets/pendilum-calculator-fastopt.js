...
function $f_Lkgi_pendilum_PendilumsCalc__calculateLengthOf__I__I__D__D($thiz, n, secondsTillRepeat, k) {
  return ($thiz.g$1 * $uD($g.Math.pow((secondsTillRepeat / ((2 * $uD($g.Math.PI)) * (1 + (k + n)))), 2.0)))
}
function $f_Lkgi_pendilum_PendilumsCalc__calculateLengths__I__I__D__sci_List($thiz, numPendilums, secondsTillRepeat, lengthOfFirst) {
  var k = $f_Lkgi_pendilum_PendilumsCalc__calculateK__I__D__D($thiz, secondsTillRepeat, lengthOfFirst);
  $m_sci_List$();
  var array = [lengthOfFirst];
  ...
  if (isEmpty$4) {
    ...
    var hi = (end >> 31);
    var lo = (((-2) + end) | 0);
    var hi$1 = ((((-2147483648) ^ lo) < 2147483646) ? hi : (((-1) + hi) | 0));
    var hi$2 = (end >> 31);
    var lo$1 = (((-2) + end) | 0);
    ...
    var hi$5 = (value >> 31);
    var lo$3 = ((lo + value) | 0);
    var hi$6 = ((((-2147483648) ^ lo$3) < ((-2147483648) ^ lo)) ? ((1 + ((hi$1 + hi$5) | 0)) | 0) : ((hi$1 + hi$5) | 0));
    var scala$collection$immutable$Range$$numRangeElements$4 = (((hi$6 === 0) ? (((-2147483648) ^ lo$3) > (-1)) : (hi$6 > 0)) ? (-1) : lo$3)
  };
  ...
  if ((scala$collection$immutable$Range$$numRangeElements$4 < 0)) {
    $m_sci_Range$().scala$collection$immutable$Range$$fail__I__I__I__Z__sr_Nothing$(2, end, 1, false)
  };
  ...
  if ((!isEmpty$4)) {
    ...
    while (true) {
      var arg1 = i$1;
      var elem = $f_Lkgi_pendilum_PendilumsCalc__calculateLengthOf__I__I__D__D($thiz, arg1, secondsTillRepeat, k);
  ...
  return $as_sci_List(jsx$2.$$plus$plus__sc_GenTraversableOnce__scg_CanBuildFrom__O(jsx$1, this$12.ReusableCBFInstance$2))
}
function $f_Lkgi_pendilum_PendilumsCalc__calculateK__I__D__D($thiz, secondsTillRepeat, lengthOfFirst) {
  return ((-2.0) + ((secondsTillRepeat / $uD($g.Math.sqrt((lengthOfFirst / $thiz.g$1)))) / (2 * $uD($g.Math.PI))))
}
/** @constructor */
function $c_O() {
  /*<skip>*/
...
/** @constructor */
function $c_Lkgi_pendilum_PendilumsCalc$delayedInit$body() {
  $c_sr_AbstractFunction0.call(this);
  this.$$outer$2 = null
}
$c_Lkgi_pendilum_PendilumsCalc$delayedInit$body.prototype = new $h_sr_AbstractFunction0();
$c_Lkgi_pendilum_PendilumsCalc$delayedInit$body.prototype.constructor = $c_Lkgi_pendilum_PendilumsCalc$delayedInit$body;
/** @constructor */
function $h_Lkgi_pendilum_PendilumsCalc$delayedInit$body() {
  /*<skip>*/
}
$h_Lkgi_pendilum_PendilumsCalc$delayedInit$body.prototype = $c_Lkgi_pendilum_PendilumsCalc$delayedInit$body.prototype;
$c_Lkgi_pendilum_PendilumsCalc$delayedInit$body.prototype.apply__O = (function() {
  this.$$outer$2.delayedEndpoint$kgi$pendilum$PendilumsCalc$1__V()
});
$c_Lkgi_pendilum_PendilumsCalc$delayedInit$body.prototype.init___Lkgi_pendilum_PendilumsCalc$ = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
var $d_Lkgi_pendilum_PendilumsCalc$delayedInit$body = new $TypeData().initClass({
  Lkgi_pendilum_PendilumsCalc$delayedInit$body: 0
}, false, "kgi.pendilum.PendilumsCalc$delayedInit$body", {
  Lkgi_pendilum_PendilumsCalc$delayedInit$body: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1
});
$c_Lkgi_pendilum_PendilumsCalc$delayedInit$body.prototype.$classData = $d_Lkgi_pendilum_PendilumsCalc$delayedInit$body;
...
/** @constructor */
function $c_Lkgi_pendilum_PendilumsCalc$() {
  $c_O.call(this);
  this.sec$1 = 0;
  this.len1$1 = 0.0;
  this.numP$1 = 0;
...
$c_Lkgi_pendilum_PendilumsCalc$.prototype = new $h_O();
$c_Lkgi_pendilum_PendilumsCalc$.prototype.constructor = $c_Lkgi_pendilum_PendilumsCalc$;
/** @constructor */
function $h_Lkgi_pendilum_PendilumsCalc$() {
  /*<skip>*/
}
$h_Lkgi_pendilum_PendilumsCalc$.prototype = $c_Lkgi_pendilum_PendilumsCalc$.prototype;
$c_Lkgi_pendilum_PendilumsCalc$.prototype.init___ = (function() {
  $n_Lkgi_pendilum_PendilumsCalc$ = this;
  this.g$1 = 9.8;
  $f_s_App__$$init$__V(this);
  var body = new $c_Lkgi_pendilum_PendilumsCalc$delayedInit$body().init___Lkgi_pendilum_PendilumsCalc$(this);
  this.scala$App$$initCode$1.$$plus$eq__O__scm_ListBuffer(body);
  return this
});
$c_Lkgi_pendilum_PendilumsCalc$.prototype.$$js$exported$meth$calculatePendilumsLengths__I__I__D__O = (function(numPendilums, secondsTillRepeat, lengthOfFirst) {
  return this.calculatePendilumsLengths__I__I__D__sjs_js_Array(numPendilums, secondsTillRepeat, lengthOfFirst)
});
$c_Lkgi_pendilum_PendilumsCalc$.prototype.delayedEndpoint$kgi$pendilum$PendilumsCalc$1__V = (function() {
  this.sec$1 = 24;
  this.len1$1 = 0.23;
  this.numP$1 = 10;
  var numPendilums = this.numP$1;
  var secondsTillRepeat = this.sec$1;
  var lengthOfFirst = this.len1$1;
  var this$2 = $f_Lkgi_pendilum_PendilumsCalc__calculateLengths__I__I__D__sci_List(this, numPendilums, secondsTillRepeat, lengthOfFirst);
  var this$1 = $m_sci_List$();
  var bf = this$1.ReusableCBFInstance$2;
  this.lengths$1 = $as_sci_List($f_sc_IterableLike__zipWithIndex__scg_CanBuildFrom__O(this$2, bf));
  var jsx$2 = this.sec$1;
  var jsx$1 = this.numP$1;
  var this$3 = this.lengths$1;
  var x = (((((("for " + jsx$2) + " repeat and ") + jsx$1) + " we got lengths: ") + $f_sc_TraversableOnce__mkString__T__T__T__T(this$3, "\n", "\n", "\n")) + " ");
...
$c_Lkgi_pendilum_PendilumsCalc$.prototype.main__AT__V = (function(args) {
  $f_s_App__main__AT__V(this, args)
});
$c_Lkgi_pendilum_PendilumsCalc$.prototype.calculatePendilumsLengths__I__I__D__sjs_js_Array = (function(numPendilums, secondsTillRepeat, lengthOfFirst) {
  var res = [];
  var this$4 = $f_Lkgi_pendilum_PendilumsCalc__calculateLengths__I__I__D__sci_List(this, numPendilums, secondsTillRepeat, lengthOfFirst);
  var len = $f_sc_LinearSeqOptimized__length__I(this$4);
  var result = $newArrayObject($d_D.getArrayOf(), [len]);
  $f_sc_TraversableOnce__copyToArray__O__I__V(this$4, result, 0);
  var i = 0;
  var len$1 = result.u.length;
  while ((i < len$1)) {
    var idx = i;
    var arg1 = result.get(idx);
    res.push(arg1);
    i = ((1 + i) | 0)
  };
  return res
});
$c_Lkgi_pendilum_PendilumsCalc$.prototype.calculatePendilumsLengths = (function(arg$1, arg$2, arg$3) {
  var prep0 = $uI(arg$1);
  var prep1 = $uI(arg$2);
  var prep2 = $uD(arg$3);
  return this.$$js$exported$meth$calculatePendilumsLengths__I__I__D__O(prep0, prep1, prep2)
});
var $d_Lkgi_pendilum_PendilumsCalc$ = new $TypeData().initClass({
  Lkgi_pendilum_PendilumsCalc$: 0
}, false, "kgi.pendilum.PendilumsCalc$", {
  Lkgi_pendilum_PendilumsCalc$: 1,
  O: 1,
  Lkgi_pendilum_PendilumsCalc: 1,
  s_App: 1,
  s_DelayedInit: 1
});
$c_Lkgi_pendilum_PendilumsCalc$.prototype.$classData = $d_Lkgi_pendilum_PendilumsCalc$;
var $n_Lkgi_pendilum_PendilumsCalc$ = (void 0);
function $m_Lkgi_pendilum_PendilumsCalc$() {
  if ((!$n_Lkgi_pendilum_PendilumsCalc$)) {
    $n_Lkgi_pendilum_PendilumsCalc$ = new $c_Lkgi_pendilum_PendilumsCalc$().init___()
  };
  return $n_Lkgi_pendilum_PendilumsCalc$
}
function $is_T(obj) {
...
$c_scm_ArrayBuffer.prototype.$classData = $d_scm_ArrayBuffer;
$e.PendilumsCalculator = $m_Lkgi_pendilum_PendilumsCalc$();
$m_Lkgi_pendilum_PendilumsCalc$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
//# sourceMappingURL=pendilum-calculator-fastopt.js.map
